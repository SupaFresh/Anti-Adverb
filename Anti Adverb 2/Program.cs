...
namespace Anti_Adverb_2
{
    class Program
    {
        public static void Main()
        {
            while (true)
            {
                Console.WriteLine("Please input a word. Lowercase only!");
                string word = Console.ReadLine();

                if (words.Contains(word))
                {
                    Console.WriteLine("Yes, " + word + " is an adverb!");
                }

                else if (string.Equals(word, nothing))
                {
                    Console.WriteLine("Type Something...");
                }

                else if (string.Equals(word, version))
                {
                    Console.WriteLine("Anti Adverb V1.2");
                }

                else if (string.Equals(word, exit))
                {
                    Console.WriteLine("Goodbye!");
                    return;
                }

                //else if (string.Equals(word, gotime))
                //    Propro();

                else
                {
                    Console.WriteLine("No, " + word + " is not an adverb!");
                }
            }
        }
